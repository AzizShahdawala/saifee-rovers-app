...
export default function PatrolScoreboard() {
  ...
  return <Box>
    <PageHeader title="Patrol Scoreboard" subtitle="Award or deduct patrol points and review rankings for any date range." actionLabel="Add Points" actionIcon={<LeaderboardOutlined />} onAction={openAdd} />
