    ...
    <Box>
      ...
      <Dialog open={Boolean(editMember)} onClose={closeMember} fullWidth maxWidth="sm">
        ...
        <DialogContent><Stack spacing={2} sx={{ pt: 1 }}>
          ...
          <TextField disabled={dialogMode === "view"} label="Hijri Date of Birth" value={editMember?.hijriDateOfBirth || ""} placeholder="1442-09-15" inputProps={{ inputMode: "numeric", maxLength: 10 }} error={dialogMode === "edit" && !isValidHijriDate(editMember?.hijriDateOfBirth)} helperText={dialogMode === "edit" ? "Umm al-Qura calendar format: YYYY-MM-DD" : ""} onChange={(event) => setEditMember((current) => ({ ...current, hijriDateOfBirth: event.target.value }))} required />
