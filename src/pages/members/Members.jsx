    ...
    <Box>
      ...
      <Dialog open={Boolean(editMember)} onClose={closeMember} fullWidth maxWidth="sm">
        ...
        <DialogContent><Stack spacing={2} sx={{ pt: 1 }}>
          ...
          <HijriDatePicker disabled={dialogMode === "view"} value={editMember?.hijriDateOfBirth || ""} onChange={(value) => setEditMember((current) => ({ ...current, hijriDateOfBirth: value }))} required error={dialogMode === "edit" && !isValidHijriDate(editMember?.hijriDateOfBirth)} helperText={dialogMode === "edit" ? "Select the member's Islamic-calendar birth date" : "Umm al-Qura calendar"} />
